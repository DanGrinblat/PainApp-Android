...
#ifndef EMBEDDED
jstring Java_com_dragonid_pain_main_MainActivity_ndkDecrypt(JNIEnv * env, jobject this, jstring b64StringIn)
{
    jboolean isCopy;
    unsigned char * b64String = (*env)->GetStringUTFChars(env, b64StringIn, &isCopy);


    AesCtx ctx;
    unsigned char iv[] = "0000000000000000";
    unsigned char key[] = {0xba,0x78,0x16,0xbf,0x8f,0x01,0xcf,0xea,0x41,0x41,0x40,0xde,0x5d,0xae,0x22,0x23,
0xb0,0x03,0x61,0xa3,0x96,0x17,0x7a,0x9c,0xb4,0x10,0xff,0x61,0xf2,0x00,0x15,0xad};
    unsigned char databuf[] = "123123123123123"; // must be in multiple of 16
